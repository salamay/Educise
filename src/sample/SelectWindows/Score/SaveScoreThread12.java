...
public class SaveScoreThread12 extends Thread {
    ...
    public SaveScoreThread12(String scoreTable,String studentname,  double data,String Subject) {
    ...
    public void run() {
        ...
        if (conn!=null){
            String Query="update "+ScoreTable+" set exam=? where studentname=? and Subject=?";
            try {
