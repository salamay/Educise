...
public class SaveScoreThread5 extends Thread {
    ...
    public SaveScoreThread5(String scoreTable,String studentname,  double data,String Subject) {
    ...
    public void run() {
        ...
        if (conn!=null){
            String Query="update "+ScoreTable+" set fourthca=? where studentname=? and Subject=?";
            try {
