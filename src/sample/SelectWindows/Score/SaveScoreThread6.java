...
public class SaveScoreThread6 extends Thread {
    ...
    public SaveScoreThread6(String scoreTable,String studentname,  double data,String Subject) {
    ...
    public void run() {
        ...
        if (conn!=null){
            String Query="update "+ScoreTable+" set fifthca=? where studentname=? and Subject=?";
            try {
