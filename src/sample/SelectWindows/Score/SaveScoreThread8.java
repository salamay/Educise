...
public class SaveScoreThread8 extends Thread {
    ...
    public SaveScoreThread8(String scoreTable,String studentname,  double data,String Subject) {
    ...
    public void run() {
        ...
        if (conn!=null){
            String Query="update "+ScoreTable+" set seventhca=? where studentname=? and Subject=?";
            try {
