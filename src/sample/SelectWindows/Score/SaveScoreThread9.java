...
public class SaveScoreThread9 extends Thread {
    ...
    public SaveScoreThread9(String scoreTable,String studentname,  double data,String Subject) {
    ...
    public void run() {
        ...
        if (conn!=null){
            String Query="update "+ScoreTable+" set eightca=? where studentname=? and Subject=?";
            try {
