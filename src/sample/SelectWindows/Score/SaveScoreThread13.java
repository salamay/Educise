...
public class SaveScoreThread13 extends Thread {
    ...
    public SaveScoreThread13(String scoreTable,String studentname,  double data,String Subject) {
    ...
    public void run() {
        ...
        if (conn!=null){
            String Query="update "+ScoreTable+" set cummulative=? where studentname=? and Subject=?";
            try {
