...
public class SaveScoreThread11 extends Thread {
    ...
    public SaveScoreThread11(String scoreTable,String studentname,  double data,String Subject) {
    ...
    public void run() {
        ...
        if (conn!=null){
            String Query="update "+ScoreTable+" set tenthca=? where studentname=? and Subject=?";
            try {
