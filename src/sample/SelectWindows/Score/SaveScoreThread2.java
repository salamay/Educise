...
public class SaveScoreThread2 extends Thread {
    ...
    public SaveScoreThread2(String scoreTable,String studentname,  double data,String Subject) {
    ...
    public void run() {
        ...
        if (conn==null){
            ...
            String Query="update "+ScoreTable+" set firstca=? where studentname=? and Subject=?";
            try {
