...
public class SaveScoreThread4 extends Thread {
    ...
    public SaveScoreThread4(String scoreTable,String studentname,  double data,String Subject) {
    ...
    public void run() {
        ...
        if (conn!=null){
            String Query="update "+ScoreTable+" set thirdca=? where studentname=? and Subject=?";
            try {
