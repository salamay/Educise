...
public class SaveScoreThread7 extends Thread {
    ...
    public SaveScoreThread7(String scoreTable,String studentname,  double data,String Subject) {
    ...
    public void run() {
        ...
        if (conn!=null){
            String Query="update "+ScoreTable+" set sixthca=? where studentname=? and Subject=?";
            try {
